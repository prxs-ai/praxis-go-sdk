module github.com/praxis/praxis-go-sdk
...
replace github.com/ipshipyard/p2p-forge => ./p2p-forge

replace github.com/ipshipyard/p2p-forge/client => ./p2p-forge/client
